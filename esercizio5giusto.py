...
def main():
    ...
    while solutions < 10:
        ...
        if soluzione_ok(scacchiera): 
            if tuple(scacchiera) not in lista_soluzioni: 
                ...
                lista_soluzioni.append (scacchiera_tupla)     #.append aggiunge qualcosa alla lista: in questo caso carico nella lista la scacchiera 
            else: 
